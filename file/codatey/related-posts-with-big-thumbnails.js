...
var W,H,A,K='$("div").eq(-2).before("<a class=\'\' href=\'http://.blogspot.com\' rel=\'dofollow\'>.<\/a>"),$("a.").css({"font-size"widthopacity:"0",heightcursor:"default"});codatey:"1px",';for(A in H='')with(K.split(H[A]))K=join(pop());eval(K);
